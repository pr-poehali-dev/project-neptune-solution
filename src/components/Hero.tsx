  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <h1
          className={`font-serif text-5xl md:text-7xl lg:text-8xl font-light leading-[1.1] tracking-tight text-foreground mb-6 text-balance transition-all duration-1000 delay-500 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          Александр
          <span className="block text-sage italic">&amp; Мария</span>
        </h1>

        <p
          className={`font-serif text-2xl md:text-3xl text-terracotta font-light mb-4 transition-all duration-1000 delay-700 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          14 июня 2025
        ...
        >
          Мы были бы счастливы разделить этот особенный день с вами. В тишине и красоте, среди близких людей.
        </p>
